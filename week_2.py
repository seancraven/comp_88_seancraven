...
def gradient_descent(
    z, loss_func, grad_func, lr=0.01, loss_stop=1e-4, z_stop=1e-4, max_iter=100
):
    """
    ...
    i = 0
    while (
        i < max_iter and abs_loss_bound(zs, z_stop) and loss_func(zs[-1]) > loss_stop
    ):
...
def logistic_regression(
    ...
    return gradient_descent(w0, binary_cross_entropy, grad_binary_cross, lr, loss_stop, weight_stop, max_iter)
